...
# Distance betweem root system is 40 cm
# Simulation output Root leng density [cm/cm3] (variable name RLD) and growing rate [cm/day] (variable name RLD_change) at each time step 
...
for t in range(0,simtime):
	...
	plt.plot(RLD_change,z,'k-', color="blue",linewidth=2)
	x1,x2,y1,y2 = plt.axis()
	plt.axis((0,x2,y1,y2)) # set min of x axis to 0, because of some negative values of (mean-std)
