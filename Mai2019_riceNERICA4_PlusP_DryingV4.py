...
name = "Mai2019/Rice_NERICA4_PlusP_Drying_Mai_2019_V4"
outputname = name
ColumnHeight = 55
ColumnRadius = 8
IsBox = False
...
massPerVolume = 0.14 # g cm-3
realData = [41.94, 29.03, 29.03]
realMass = [3.1]
...
for rs in allRS:
      ...
      ana.write("results/"+outputname+str(c)+".dgf")
      ana.write("results/"+outputname+str(c)+".vtp")
