...
public:
    ...
    virtual Vector2d getHeading(const Vector3d& pos, Matrix3d old, double dx, const Root* root);
...
public:
    ...
    virtual Vector2d getHeading(const Vector3d& pos, Matrix3d old,  double dx, const Root* root = nullptr) override;
