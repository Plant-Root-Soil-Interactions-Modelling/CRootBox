...
\caption{Central core} \label{fig:soilcore1} \label{fig:central}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{example_3b2.png} 
\caption{Shifted core} \label{fig:soilcore2} \label{fig:shifted}
\end{figure}
...
\lstinputlisting[language=Python, caption=Example 3e (modified 1b)]{../example3e.py}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{example_4a.png}
\caption{Chemotropism in a nutrient rich layer} \label{fig:sa}
\end{figure}

\subsection{User defined tropisms}

Normally, the simulation is created from a set of parameters. For tropisms these are the type of tropism, number of trials $N$ , and tortuosity $\sigma$
