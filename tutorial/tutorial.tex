...
The user has to extend the new tropism class from the class TropismFunction. 
...
\lstinputlisting[firstline=1,lastline=50, language=Python, caption=Example 4b]{../example4b.py}
...
\lstinputlisting[firstline=51,lastline=81, language=Python, caption=Example 4b]{../example4b.py}
